...
[Tool]
#endif
public class InkStory : Reference
{
#region Signals
...
#region Initialisation
	...
	public InkStory(String storyJson)
	{
...
#region Story loading
	...
	/// </summary>
	/// <param name="storyJson">A string containing the json representation of the story.</param>
	/// <returns>False if there was an error while loading, true otherwise.</returns>
	private Boolean LoadStoryFromString(String storyJson)
	{
		Reset();

		story = new Ink.Runtime.Story(storyJson);
